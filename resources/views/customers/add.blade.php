                            ...
                            <div class="p-2">
                                <form method="POST" action="{{ route('customers.store') }}">
                                    ...
                                    <div class="mb-3">
                                      ...
                                      <textarea class="form-control" placeholder="Masukan Alamat Disini" name="alamat"></textarea>
                                    </div>
                                    <div class="mb-3">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control text-uppercase" name="no_kendaraan" id="no_kendaraan" >
                                    </div>
